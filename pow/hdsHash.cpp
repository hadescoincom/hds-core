...
struct Block::PoW::Helper
{
	...
	EquihashR<150,5,0> HdsHashI;
	EquihashR<150,5,3> HdsHashII;
	HdsHash_III       HdsHashIII;
...
bool Block::PoW::Solve(const void* pInput, uint32_t nSizeInput, Height h, const Cancel& fnCancel)
{
	...
	std::function<bool(const hds::ByteBuffer&)> fnValid = [this, &hlp](const hds::ByteBuffer& solution)
		{
