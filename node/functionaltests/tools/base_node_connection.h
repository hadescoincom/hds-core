...
class BaseNodeConnection : public hds::proto::NodeConnection
{
public:
...
protected:
	hds::io::Reactor::Ptr m_Reactor;
	hds::io::Reactor::Scope m_Scope;
	hds::io::Timer::Ptr m_Timer;
	bool m_Failed;
