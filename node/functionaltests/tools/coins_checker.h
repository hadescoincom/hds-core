...
public:
	...
	using Callback = std::function<void(bool, hds::Height)>;
public:
...
protected:
    ...
    void OnMsg(hds::proto::Authentication&&) override;
	void OnDisconnect(const DisconnectReason&) override;
	void OnMsg(hds::proto::NewTip&&) override;
	void OnMsg(hds::proto::ProofUtxo&&) override;
...
protected:
	...
	bool m_IsOk;
	hds::Height m_Maturity;
	hds::Block::SystemState::Full m_Hdr;
