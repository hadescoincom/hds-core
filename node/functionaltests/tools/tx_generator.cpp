...
void TxGenerator::GenerateInputInTx(Height h, Amount v, hds::Key::Type keyType, uint32_t ind)
{
	Scalar::Native key;
...
void TxGenerator::GenerateOutputInTx(Height h, Amount v, hds::Key::Type keyType, bool isPublic, uint32_t ind)
{
