...
notarize_dmg() {(
  ...
  uploadRes=$(xcrun altool --notarize-app --primary-bundle-id "com.com.hadescoin.hdswallet" --username "$MACOS_NOTARIZE_USER" --password "$MACOS_NOTARIZE_PASS" --file "$HDS_WALLET_UI_IN" --verbose 2>&1)
