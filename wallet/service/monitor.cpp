...
namespace
{
    ...
    private:
        ...
        void OnWalletMessage(const wallet::WalletID& peerID, const wallet::SetTxParameter& msg) override
        {
            ...
            {
                hds::Amount amount = 0;
                msg.GetParameter<hds::Amount>(TxParameterID::Amount, amount);
...
int main(int argc, char* argv[])
{
    ...
    auto logger = hds::Logger::create(LOG_LEVEL_DEBUG, LOG_LEVEL_DEBUG, LOG_LEVEL_DEBUG, LOG_FILES_PREFIX, path.string());
    ...
    try
    {
        ...
        io::Reactor::Ptr reactor = io::Reactor::create();
        {
            ...
            clean_old_logfiles(LOG_FILES_DIR, LOG_FILES_PREFIX, hds::wallet::days2sec(options.logCleanupPeriod));
            getRulesOptions(vm);

            Rules::get().UpdateChecksum();
            LOG_INFO() << "Hds Wallet SBBS Monitor " << PROJECT_VERSION << " (" << BRANCH_NAME << ")";
        ...
        LogRotation logRotation(*reactor, LOG_ROTATION_PERIOD_SEC, hds::wallet::days2sec(options.logCleanupPeriod));
