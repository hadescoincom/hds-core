...
namespace
{
    ...
    void TestNewsChannelsObservers()
    {
        ...
        std::vector<ExchangeRate> rates {
            { ExchangeRate::Currency::Hds, ExchangeRate::Currency::Usd, 147852369, getTimestamp() } };
    ...
    void TestExchangeRateProvider()
    {
        ...
        // update rate
        {
            ...
            const std::vector<ExchangeRate> rateOlder {
                { ExchangeRate::Currency::Hds, ExchangeRate::Currency::Usd, 14785238554, getTimestamp()-100 }
            };
        ...
        // add more rate
        {
            ...
            const std::vector<ExchangeRate> rateAdded {
                { ExchangeRate::Currency::Hds, ExchangeRate::Currency::Bitcoin, 987, getTimestamp()+100 }
            };
    ...
    void TestNotificationsOnOffSwitching()
    {
        ...
        std::map<Notification::Type,bool> activeTypes {
            ...
            { Notification::Type::HdsNews, false },
