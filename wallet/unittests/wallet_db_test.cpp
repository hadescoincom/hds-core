...
void TestStoreTxRecord()
{
    ...
    WALLET_CHECK(t[0].m_changeHds == tr.m_changeHds);
...
void TestAddresses()
{
    ...
    a.m_createTime = hds::getTimestamp();
    a.m_duration = 23;
    a.m_OwnID = 44;
    ...
    c.m_createTime = hds::getTimestamp();
    c.m_duration = 23;
    c.m_OwnID = 0;
...
void TestSelect7()
{
    // https://github.com/hadescoincom/hds/issues/1339
    cout << "\nWallet database coin selection 7 test https://github.com/hadescoincom/hds/issues/1339\n";
    auto db = createSqliteWalletDB();
...
void TestNotifications()
{
...

    {
        ...
        // update notification
        n1.m_type = Notification::Type::HdsNews;
...
void TestExchangeRates()
{
    ...
    {
        // store rate
        ExchangeRate r1 { ExchangeRate::Currency::Hds,
