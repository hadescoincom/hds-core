    ...
    , m_bbsTimestamp(getTimestamp())
{
    ...
    m_lastState = hds::Lightning::Channel::get_State();
    m_Params = params;
}
...
void Channel::LogState()
{
    ...
    case hds::Lightning::Channel::State::Open:
        ...
        break;
    case hds::Lightning::Channel::State::Updating:
        os << "Updating (creating newer Revision)";
        break;
    case hds::Lightning::Channel::State::Closing1:
        os << "Closing1 (decided to close, sent Phase-1 withdrawal)";
        break;
    case hds::Lightning::Channel::State::Closing2:
        {
        ...
        break;
    case hds::Lightning::Channel::State::Closed:
...
void Channel::Subscribe()
{
    ...
    m_isSubscribed = true;
    LOG_INFO() << "hds::wallet::laser::Channel WalletID: "  << std::to_string(get_myWID()) << " subscribes to BBS channel: " << ch;
}
...
void Channel::Unsubscribe()
{
    ...
    LOG_INFO() << "hds::wallet::laser::Channel WalletID: "  << std::to_string(get_myWID()) << " unsubscribed from BBS channel: " << ch;
