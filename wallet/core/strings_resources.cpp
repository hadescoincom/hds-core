...
namespace hds
{
    const char kDefaultConfigFile[] = "hds-wallet.cfg";
    const char kHDS[] = "HDS";
    ...
    const char kSwapTxStatusBuildingHdsLockTX[] = "building Hds LockTX";
    const char kSwapTxStatusBuildingHdsRefundTX[] = "building Hds RefundTX";
    const char kSwapTxStatusBuildingHdsRedeemTX[] = "building Hds RedeemTX";
    ...
    const char kSwapTxStatusSendingHdsLockTX[] = "sending Hds LockTX";
    const char kSwapTxStatusSendingHdsRefundTX[] = "sending Hds RefundTX";
    const char kSwapTxStatusSendingHdsRedeemTX[] = "sending Hds RedeemTX";
    ...
    const char kHdsFee[] = " (HDS Fee)";
    const char kHdsRefund[] = " (HDS Refund)";
    ...
    const char kTxHistoryColumnAmount[] = "amount, HDS";
    ...
    const char kVersionInfo[] = "Hds Wallet %1% (%2%)";
