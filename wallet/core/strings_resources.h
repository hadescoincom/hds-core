...
namespace hds
{
    ...
    extern const char kSwapTxStatusBuildingHdsLockTX[];
    extern const char kSwapTxStatusBuildingHdsRefundTX[];
    extern const char kSwapTxStatusBuildingHdsRedeemTX[];
    ...
    extern const char kSwapTxStatusSendingHdsLockTX[];
    extern const char kSwapTxStatusSendingHdsRefundTX[];
    extern const char kSwapTxStatusSendingHdsRedeemTX[];
    ...
    extern const char kHdsFee[];
    extern const char kHdsRefund[];
