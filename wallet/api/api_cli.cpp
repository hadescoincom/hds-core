...
private:
    ...
    hds::bitcoin::IBridgeHolder::Ptr _btcBridgeHolder;
    hds::bitcoin::IBridgeHolder::Ptr _ltcBridgeHolder;
    hds::bitcoin::IBridgeHolder::Ptr _qtumBridgeHolder;
...
int main(int argc, char* argv[])
{
    ...
    auto logger = hds::Logger::create(LOG_LEVEL_DEBUG, LOG_LEVEL_DEBUG, LOG_LEVEL_DEBUG, "api_", path.string());
    ...
    try
    {
...

        {
            ...
            LOG_INFO() << "Hds Wallet API " << PROJECT_VERSION << " (" << BRANCH_NAME << ")";
