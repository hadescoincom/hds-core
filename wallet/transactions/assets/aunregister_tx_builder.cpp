...
namespace hds::wallet
{
        ...
        , m_Offset(Zero)
    {
        ...
        // and pay fees from ASSET->HDS conversion. But need to be sure that
        // this conversion generates enough HDSs
    ...
    void AssetUnregisterTxBuilder::AddRefund()
    {
        ...
        if (refundAmount)
        {
            GenerateHdsCoin(refundAmount, false);
        }
    }

    void AssetUnregisterTxBuilder::GenerateHdsCoin(Amount amount, bool change)
    {
