...
namespace hds::wallet
{
    ...
    {
    public:
        BitcoinSide(BaseTransaction& tx, bitcoin::IBridge::Ptr bitcoinBridge, bitcoin::ISettingsProvider& settingsProvider, bool isHdsSide);
        virtual ~BitcoinSide();
    ...
    protected:
        virtual uint32_t GetLockTxEstimatedTimeInHdsBlocks() const;
