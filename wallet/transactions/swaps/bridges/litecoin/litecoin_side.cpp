...
namespace
{
    ...
    constexpr uint32_t kLitecoinLockTxEstimatedTimeInHdsBlocks = 20;   // it's average value
}

namespace hds::wallet
{
    LitecoinSide::LitecoinSide(BaseTransaction& tx, bitcoin::IBridge::Ptr bitcoinBridge, litecoin::ISettingsProvider& settingsProvider, bool isHdsSide)
    ...
    uint32_t LitecoinSide::GetLockTxEstimatedTimeInHdsBlocks() const
    {
        return kLitecoinLockTxEstimatedTimeInHdsBlocks;
    }
}