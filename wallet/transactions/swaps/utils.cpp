...
const char* getSwapTxStatus(AtomicSwapTransaction::State state)
{
    ...
    static const char* BuildingHdsLockTX = "building Hds LockTX";
    static const char* BuildingHdsRefundTX = "building Hds RefundTX";
    static const char* BuildingHdsRedeemTX = "building Hds RedeemTX";
    ...
    static const char* SendingHdsLockTX = "sending Hds LockTX";
    static const char* SendingHdsRefundTX = "sending Hds RefundTX";
    static const char* SendingHdsRedeemTX = "sending Hds RedeemTX";
