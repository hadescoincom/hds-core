...
#define HDS_JAVA_PACKAGE(sep)                     com ## sep ## mw ## sep ## hds ## sep ## hdswallet ## sep ## core
#define HDS_JAVA_PREFIX                         HDS_JAVA_PACKAGE(_)
#define HDS_JAVA_PATH                             "com/com/hadescoin/hdswallet/core" // doesn't work on clang DEF2STR(HDS_JAVA_PACKAGE(/))
#define HDS_JAVA_API_INTERFACE(function)         CONCAT1(HDS_JAVA_PREFIX, Api, function)
#define HDS_JAVA_WALLET_INTERFACE(function)     CONCAT1(HDS_JAVA_PREFIX, entities_Wallet, function)
