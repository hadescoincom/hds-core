...
namespace
{
    ...
    void initLogger(const string& appData, const string& appVersion)
    {
        ...
        LOG_INFO() << "Hds Mobile Wallet " << appVersion << " (" << BRANCH_NAME << ") library: " << PROJECT_VERSION;
    ...
    std::map<Notification::Type,bool> initNotifications(bool initialValue)
    {
        return std::map<Notification::Type,bool> {
            ...
            { Notification::Type::HdsNews,                  initialValue },
...
JNIEXPORT jobject JNICALL HDS_JAVA_API_INTERFACE(createWallet)(JNIEnv *env, jobject thiz,
...
JNIEXPORT jboolean JNICALL HDS_JAVA_API_INTERFACE(isWalletInitialized)(JNIEnv *env, jobject thiz,
    jstring appData)
{
...
JNIEXPORT void JNICALL HDS_JAVA_API_INTERFACE(closeWallet)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT jboolean JNICALL HDS_JAVA_API_INTERFACE(isWalletRunning)(JNIEnv *env, jobject thiz)
{
    return walletModel != nullptr;
}

JNIEXPORT jobject JNICALL HDS_JAVA_API_INTERFACE(openWallet)(JNIEnv *env, jobject thiz,
...
JNIEXPORT jobject JNICALL HDS_JAVA_API_INTERFACE(createMnemonic)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT jobject JNICALL HDS_JAVA_API_INTERFACE(getDictionary)(JNIEnv *env, jobject thiz)
{
    //auto phrases = hds::createMnemonic(hds::getEntropy(), hds::language::en);
...
JNIEXPORT jobject JNICALL HDS_JAVA_API_INTERFACE(getDefaultPeers)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT jboolean JNICALL HDS_JAVA_API_INTERFACE(checkReceiverAddress)(JNIEnv *env, jobject thiz, jstring address)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(getWalletStatus)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(getTransactions)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(getUtxosStatus)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(syncWithNode)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(sendMoney)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(calcChange)(JNIEnv *env, jobject thiz,
    jlong amount)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(getAddresses)(JNIEnv *env, jobject thiz,
    jboolean own)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(generateNewAddress)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(saveAddress)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(importRecovery)(JNIEnv *env, jobject thiz, jstring jpath)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(updateAddress)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(saveAddressChanges)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(cancelTx)(JNIEnv *env, jobject thiz,
    jstring txId)
{
    LOG_DEBUG() << "cancelTx()";
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(deleteTx)(JNIEnv *env, jobject thiz,
    jstring txId)
{
    LOG_DEBUG() << "deleteTx()";
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(deleteAddress)(JNIEnv *env, jobject thiz,
    jstring walletID)
{
    WalletID id(Zero);
...
JNIEXPORT jboolean JNICALL HDS_JAVA_WALLET_INTERFACE(checkWalletPassword)(JNIEnv *env, jobject thiz,
    jstring password)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(changeWalletPassword)(JNIEnv *env, jobject thiz,
    jstring password)
{
    auto pass = JString(env, password).value();
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(getPaymentInfo)(JNIEnv *env, jobject thiz,
    jstring txID)
{
    auto buffer = from_hex(JString(env, txID).value());
    TxID id;
...
JNIEXPORT jobject JNICALL HDS_JAVA_WALLET_INTERFACE(verifyPaymentInfo)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(getCoinsByTx)(JNIEnv *env, jobject thiz,
    jstring txID)
{
    auto buffer = from_hex(JString(env, txID).value());
    TxID id;
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(changeNodeAddress)(JNIEnv *env, jobject thiz,
    jstring address)
{
...
JNIEXPORT jstring JNICALL HDS_JAVA_WALLET_INTERFACE(exportOwnerKey)(JNIEnv *env, jobject thiz,
    jstring pass)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(importDataFromJson)(JNIEnv *env, jobject thiz,
    jstring jdata)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(exportDataToJson)(JNIEnv *env, jobject thiz)
{
    walletModel->getAsync()->exportDataToJson();
}

JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(switchOnOffExchangeRates)(JNIEnv *env, jobject thiz, jboolean isActive)
{
    walletModel->getAsync()->switchOnOffExchangeRates(isActive);
}

JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(switchOnOffNotifications)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(getNotifications)(JNIEnv *env, jobject thiz)
{
    walletModel->getAsync()->getNotifications();
}

JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(markNotificationAsRead)(JNIEnv *env, jobject thiz, jstring idString)
{
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(deleteNotification)(JNIEnv *env, jobject thiz, jstring idString)
{
    auto buffer = from_hex(JString(env, idString).value());
    Blob rawData(buffer.data(), static_cast<uint32_t>(buffer.size()));
    ECC::uintBig id(rawData);
...
JNIEXPORT void JNICALL HDS_JAVA_WALLET_INTERFACE(getExchangeRates)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/listeners/WalletListener");
        WalletListenerClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/Wallet");
        WalletClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/dto/WalletStatusDTO");
        WalletStatusClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/dto/SystemStateDTO");
        SystemStateClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/dto/TxDescriptionDTO");
        TxDescriptionClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/dto/UtxoDTO");
        UtxoClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/dto/WalletAddressDTO");
        WalletAddressClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/dto/PaymentInfoDTO");
        PaymentInfoClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/dto/ExchangeRateDTO");
        ExchangeRateClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/dto/NotificationDTO");
        NotificationClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(HDS_JAVA_PATH "/entities/dto/VersionInfoDTO");
