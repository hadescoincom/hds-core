...
package com.com.hadescoin.hdswallet.core.listeners;

import com.com.hadescoin.hdswallet.core.entities.dto.WalletStatusDTO;
import com.com.hadescoin.hdswallet.core.entities.dto.UtxoDTO;
import com.com.hadescoin.hdswallet.core.entities.dto.TxDescriptionDTO;
import com.com.hadescoin.hdswallet.core.entities.dto.WalletAddressDTO;
import com.com.hadescoin.hdswallet.core.entities.dto.PaymentInfoDTO;
import com.com.hadescoin.hdswallet.core.entities.dto.NotificationDTO;
import com.com.hadescoin.hdswallet.core.entities.dto.ExchangeRateDTO;
import com.com.hadescoin.hdswallet.core.entities.dto.VersionInfoDTO;

import com.com.hadescoin.hdswallet.core.entities.Wallet;
...
public class WalletListener
{
	...
	{
		System.out.println(">>>>>>>>>>>>>> async status in Java, available=" + status.available/1000000 + " HDS and " + status.available%1000000 + " GROTH, maturing=" + status.maturing);
	...
	static void onHdsNewsNotification(int action)
    {
		System.out.println(">>>>>>>>>>>>>> async onHdsNewsNotification in Java");
	}
