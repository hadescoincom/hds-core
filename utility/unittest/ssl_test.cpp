...
namespace {
    ...
    int test_sslio(bool requestCertificate, bool rejectUnauthorized, const string& serverCertName, const string& clientCertName = "") {
        ...
        const char* CAfile = PROJECT_SOURCE_DIR "/utility/unittest/hds_CA.pem";
...
int main() {
    ...
    const std::string clientCert = "hds_client";
    const std::string serverCert = "hds_server";
...
// should work with installed test hds CA
