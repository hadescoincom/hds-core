...
#define CHECKPOINT_CREATE(SIZE) \
    hds::CheckpointData<SIZE> COMBINE(checkpointData,__LINE__); \
    hds::Checkpoint COMBINE(checkpoint,__LINE__)(COMBINE(checkpointData,__LINE__).items, SIZE, __FILE__, __LINE__, __FUNCTION__)

#define CHECKPOINT_ADD() assert(hds::current_checkpoint()); *hds::current_checkpoint()

#define CHECKPOINT(...) \
    hds::CheckpointData<NUM_ARGS(__VA_ARGS__)> COMBINE(checkpointData,__LINE__); \
    hds::Checkpoint COMBINE(checkpoint,__LINE__)(COMBINE(checkpointData,__LINE__).items, NUM_ARGS(__VA_ARGS__), __FILE__, __LINE__, __FUNCTION__); \
