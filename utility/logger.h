...
struct LogMessageStub {
    ...
    #define LOG_MESSAGE(LEVEL) if (hds::Logger::will_log(LEVEL)) hds::LogMessage(LEVEL, __FILE__, __LINE__, __FUNCTION__)
#else
    #define LOG_MESSAGE(LEVEL) if (hds::Logger::will_log(LEVEL)) hds::LogMessage(LEVEL)
#endif
