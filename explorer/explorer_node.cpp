...
int main(int argc, char* argv[]) {
	...
	catch (const hds::CorruptionException& e) {
...
bool parse_cmdline(int argc, char* argv[], Options& o) {
    ...
    cliOptions.add_options()
        ...
        (cli::NODE_PEER, po::value<string>()->default_value("tokyo-nodes.mainnet.hadescoin.com:16668"), "peer address")
        (cli::PORT_FULL, po::value<uint16_t>()->default_value(16668), "port to start the local node on")
...
void setup_node(Node& node, const Options& o) {
    ...
    LOG_INFO() << "Hds Node Explorer " << PROJECT_VERSION << " (" << BRANCH_NAME << ")";
